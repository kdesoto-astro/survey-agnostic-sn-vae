...
project = "survey-agnostic-sn-vae"
copyright = "2023, Kaylee de Soto & Ana Sofia Uzsoy"
author = "Kaylee de Soto & Ana Sofia Uzsoy"
release = version("survey-agnostic-sn-vae")
